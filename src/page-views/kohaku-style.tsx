            ...
            <div className="text-center px-6">
              ...
              >
                ...
                <p className="text-lg md:text-xl font-light tracking-wide max-w-2xl mx-auto leading-relaxed">
                  Experience every moment. Sometimes bold, sometimes refined,
                  always with passion.
                </p>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              >
                ...
                <p className="text-base md:text-lg leading-relaxed mb-8 text-white/90">
                  ...
                  &ldquo;flavor&rdquo;. Blessed with abundant ingredients in
                  Phan Thiet, we believe we must be delicate about
                  &ldquo;flavor&rdquo; in our culinary approach.
                </p>
                <p className="text-base md:text-lg leading-relaxed mb-8 text-white/90">
                  In Asian fusion cuisine, &ldquo;flavor&rdquo; plays a crucial
                  role in cooking through our broths and stocks. These form the
                  foundation of all Asian fusion dishes.
                </p>
                <p className="text-base md:text-lg leading-relaxed text-white/90">
                  Broths enhance ingredients, broths support ingredients in
                  their natural state. At XET, we believe that by subtly
                  incorporating the aromas of spices and herbs with restraint,
                  we can fully and naturally draw out the power that each
                  ingredient possesses at that moment.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="min-h-screen relative">
            ...
            <div className="absolute inset-0 z-0">
              <div
                ...
                style={{
                  backgroundImage:
                    scrollY > 1200 ? "url('/images/0.JPG')" : "none",
              ...
              <div className="max-w-7xl mx-auto px-6 py-20">
                  ...
                  >
                    ...
                    <div className="space-y-6 mt-12">
                      <p className="text-base md:text-lg lg:text-xl leading-relaxed text-white/90">
                        At XET, we believe a great meal starts with fresh,
                        quality ingredients. From seafood and vegetables to beef
                        and local spices, everything is carefully sourced from
                        Phan Thiet and nearby regions.
                      </p>
                      <p className="text-base md:text-lg lg:text-xl leading-relaxed text-white/90">
                        We respect the roots of traditional cooking, but we also
                        love giving it a fresh twist. Every dish brings together
                        the warmth of familiar flavors with just the right touch
                        of creativity, so it feels both comforting and exciting.
                      </p>
                      <p className="text-base md:text-lg lg:text-xl leading-relaxed text-white/90">
                        Here, you’re not just enjoying a meal—you’re tasting the
                        story of the sea, the land, and the people who make Phan
                        Thiet special.
                      </p>
                    </div>
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6">
                          <div className="space-y-3">
                            ...
                            <p className="text-sm md:text-base leading-relaxed text-white/90">
                              Everyday flavors brought to life with XET’s own
                              unique style.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="relative w-full aspect-square rounded-2xl overflow-hidden shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          ...
                          <p className="text-sm leading-relaxed text-white/85">
                            From cooking to plating, every detail is made to be
                  ...
                  >
                    <div className="text-center space-y-6 p-6">
                      ...
                      <p className="text-sm md:text-base text-white/80 leading-relaxed max-w-xs">
                        Every element on the plate tells a story of culinary
                    ...
                    <div className="relative group">
                      <div className="relative w-full aspect-square rounded-2xl overflow-hidden shadow-2xl transform group-hover:scale-105 transition-all duration-500">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-4">
                          ...
                          <p className="text-sm leading-relaxed text-white/85">
                            A place to share good food, good conversation, and
                            good moments.
                          </p>
                        </div>
                      </div>
                ...
                >
                  <p className="text-lg md:text-xl font-light leading-relaxed text-white/95 italic">
                    &ldquo;We reconstruct the present on each plate, embracing
                    change as the natural evolution of culinary art.&rdquo;
                  </p>
                </div>
                  ...
                  <div className="bg-gradient-to-br from-black/80 via-gray-900/60 to-black/80 rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 backdrop-blur-sm border border-white/10 shadow-2xl">
                    ...
                    <div className="text-center mb-8 md:mb-12">
                      ...
                      <p className="text-sm sm:text-base md:text-lg text-white/70 mt-4 md:mt-6 max-w-2xl mx-auto leading-relaxed px-4">
                        Discover the artistry behind each creation, where
                        tradition meets innovation in perfect harmony
                      </p>
                    </div>
                    ...
                    <div className="text-center mt-8 md:mt-12">
                      <p className="text-white/60 text-xs sm:text-sm md:text-base mb-4 md:mb-6 italic px-4">
                        Each dish tells a story of passion, precision, and
                        culinary excellence
                      </p>
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto leading-relaxed">
                  Every corner tells a story. From intimate dining nooks to
                  vibrant social spaces, discover the carefully crafted
                  environments that make XET a destination.
                </p>
              </div>
              ...
              >
                <div className="bg-gradient-to-r from-transparent via-white/5 to-transparent p-8 md:p-12 rounded-3xl backdrop-blur-sm">
                  <p className="text-lg md:text-xl font-light leading-relaxed text-white/95 italic mb-6">
                    &ldquo;Each space within XET has been thoughtfully designed
                    to create moments of connection— between people, between
                    flavors, and between the artistry of cuisine and the comfort
                    of home.&rdquo;
                  </p>
